...
class Quiz {
    companion object {
        ...
        val q2 = Question.ImageSetQuestion(2, "Select all Irresponsibly Dressed Humans",
            arrayOf(
                Answer(1, R.drawable.q2_a1, true),
                Answer(2, R.drawable.q2_a2, false),
                Answer(3, R.drawable.q2_a3, true),
                Answer(4, R.drawable.q2_a4, true),
                Answer(5, R.drawable.q2_a5, true),
                Answer(6, R.drawable.q2_a6, false),
                Answer(7, R.drawable.q2_a7, true),
                Answer(8, R.drawable.q2_a8, true),
                Answer(8, R.drawable.q2_a9, true)))
